...
This is an **updated version** of my previous portfolio website. It has been enhanced with a modern design, improved interactivity, and new features. The development was assisted using **Cursor.ai** for efficient and AI-powered coding.
...
- **AI-Powered Enhancements**: Built using Cursor.ai to streamline and improve the development process.
